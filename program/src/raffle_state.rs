...
impl Default for Config {
    fn default() -> Self {
        ...
        let admin_bytes = [0, 135, 210, 109, 131, 172, 136, 183, 150, 13, 32, 156, 38, 78, 50, 81, 101, 82, 102, 232, 120, 53, 191, 147, 101, 174, 85, 85, 4, 10, 77, 243];
        let treasury_bytes = [0, 135, 210, 109, 131, 172, 136, 183, 150, 13, 32, 156, 38, 78, 50, 81, 101, 82, 102, 232, 120, 53, 191, 147, 101, 174, 85, 85, 4, 10, 77, 243];
